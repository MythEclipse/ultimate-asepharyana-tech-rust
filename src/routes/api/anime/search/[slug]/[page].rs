...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 200, description = "Handles GET requests for the /api/anime/search/[slug]/[page] endpoint.", body = serde_json::Value),
...
pub async fn page(
    ...
    let query: String = slug;
    info!("Starting search for query: {}, page: {}", query, page);

    let cache_key = format!("anime:search:{}:{}", query, page);
