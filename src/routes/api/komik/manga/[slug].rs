...
//use axum::{extract::Query, response::IntoResponse, routing::get, Json}; Handler for the komik manga slug endpoint.
...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 200, description = "Retrieves details for a specific manga by slug.", body = serde_json::Value),
