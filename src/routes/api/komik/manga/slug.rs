...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 200, description = "Handles GET requests for the /api/komik/manga/slug endpoint.", body = serde_json::Value),
...
pub fn register_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    router.route("/api/komik/manga/slug", axum::routing::get(list))
}